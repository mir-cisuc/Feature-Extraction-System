 ...
 */
package Synesketch.Files.Emotion.Util;
...
import Synesketch.Files.Emotion.AffectWord;
import Synesketch.Files.Util.PropertiesManager;
...
public class LexicalUtility {
	...
	private String folder = "/Synesketch/Files/Data/Lex/";

	private String fileNameLexicon = folder + "synesketch_lexicon.txt";
	private String fileNameEmoticons = folder + "synesketch_lexicon_emoticons.txt";
	private String fileNameProperties = folder + "keywords.xml";
